...
import tempfile
import os
from src.n8n_builder.models.config import BuildConfig, N8nInstance, WorkflowReference, TemplateWorkflow
...
"""
    ...
    with tempfile.NamedTemporaryFile(mode='w', suffix='.yaml', delete=False) as f:
        ...
        try:
            ...
            assert template_workflow.parameters == {"param1": "value1", "param2": "value2"}
