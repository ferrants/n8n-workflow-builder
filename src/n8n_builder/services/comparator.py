...
class WorkflowComparator:
    ...
    def compare_all(self) -> Dict[str, Any]:
        ...
        for name in built_names & pulled_names:
            comparison['workflows'][name] = self._compare_workflows(
                built_workflows[name],
                pulled_workflows[name],
                name
            )
    ...
    def _compare_workflows(self, built: Dict[str, Any], pulled: Dict[str, Any], name: str) -> Dict[str, Any]:
    ...
    def _normalize_workflow(self, workflow: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if 'connections' in normalized:
            ...
            normalized['connections'] = self._sort_connections(normalized['connections'])
    ...
    def _find_differences(self, built: Dict[str, Any], pulled: Dict[str, Any]) -> List[Dict[str, Any]]:
