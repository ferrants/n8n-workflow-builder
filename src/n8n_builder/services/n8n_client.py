...
class N8nClient:
    ...
    def upload_workflow(self, workflow_path: str, workflow_name: Optional[str] = None) -> Dict[str, Any]:
    ...
    def _update_workflow(self, workflow_id: str, workflow_data: Dict[str, Any]) -> Dict[str, Any]:
